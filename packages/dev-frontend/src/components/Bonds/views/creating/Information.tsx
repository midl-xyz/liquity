...
export const Information: React.FC = () => {
  ...
  return (
    <InformationContainer>
      <Box sx={{ p: [2, 3] }}>
        <Paragraph sx={{ mt: 2 }}>
          Bonds accrue a virtual balance of boosted BUSD tokens (bBUSD) over time. At any time, the
          bonder may choose to claim their bBUSD in exchange for their BUSD, or cancel their bond to
          recover their deposited BUSD.
        </Paragraph>
        <Paragraph sx={{ mt: 3 }}>
          Please visit the&nbsp;
