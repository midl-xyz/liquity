...
const getBondEvents = (bond: OptimisticBondType): EventType[] => {
  return [
    ...
    },
    {
      ...
      label: (
        <>
          <Label description="How many bBUSD are required to break-even at the current market price.">
    ...
    },
    {
      ...
      label: (
        <>
          <Label description="How many bLUSD are recommended before claiming the bond, selling the bBUSD for BUSD, and then opening another bond.">
